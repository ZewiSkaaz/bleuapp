...
const steps = [
  ...
  {
    number: 4,
    title: 'Lier un Compte Master MT5',
    icon: Shield,
    color: 'text-amber-400',
    bgColor: 'bg-amber-500/10',
    content: [
      { type: 'text', value: "Le compte Master est celui qui trade. BleuApp réplique automatiquement chaque trade vers les comptes de vos clients." },
      { type: 'heading', value: 'Connexion via MetaAPI :' },
      ...
      { type: 'step', value: "Dans l'Admin → Comptes Master (MT5), cliquez sur 'Lier un compte'" },
      { type: 'step', value: "Sélectionnez votre broker, serveur, et entrez vos identifiants MT5" },
      { type: 'step', value: "MetaAPI synchronisera automatiquement votre compte" },
      { type: 'warning', value: "Utilisez le mot de passe Investor (lecture seule) pour plus de sécurité, ou le mot de passe Trader si vous voulez du copy trading actif." },
    ]
  },
  {
    number: 5,
    title: 'Lancer le Copy Trading',
    icon: Terminal,
    color: 'text-rose-400',
    bgColor: 'bg-rose-500/10',
    content: [
      { type: 'text', value: "Une fois le compte Master connecté, vous pouvez activer la réplication automatique des trades." },
      { type: 'heading', value: 'Activation :' },
      { type: 'step', value: "Allez dans Admin → Paramètres (Copy Trading)" },
      { type: 'step', value: "Cliquez sur le bouton vert 'Lancer le copie automatique'" },
      { type: 'step', value: "Le moteur va surveiller votre compte Master en temps réel" },
      { type: 'step', value: "Chaque nouveau trade sera répliqué sur les comptes clients actifs" },
      { type: 'step', value: "Surveillez les positions en direct dans le tableau de bord" },
      { type: 'info', value: "Vous pouvez mettre en pause ou arrêter le copy trading à tout moment sans perdre les positions ouvertes." },
    ]
  },
]
